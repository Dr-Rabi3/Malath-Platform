...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-2 !my-5">
      <div className="container max-w-[900px] bg-accent-25 flex flex-col md:flex-row p-4 justify-between items-center shadow-md gap-5 md:gap-10 w-full">
        <RegisterForm className="w-full" />
        <div className="relative w-full h-full hidden md:block">
          <img
            src={photo}
            alt="register photo"
            className="w-full max-w-xs md:max-w-md lg:max-w-lg max-h-[600px] self-center"
          />
          <div
